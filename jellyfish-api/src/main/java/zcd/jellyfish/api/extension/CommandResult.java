...
public final class CommandResult {
     ...
     */
    private CommandResult(Kind kind, String output) {
        this.kind = kind;
        this.output = output;
    }
    ...
    public static CommandResult ok(String output) {
        return new CommandResult(Kind.OK, output);
    }
    ...
    public static CommandResult error(String output) {
        return new CommandResult(Kind.ERROR, output);
    }
    ...
    public static CommandResult unknown(String output) {
        return new CommandResult(Kind.UNKNOWN, output);
    }
