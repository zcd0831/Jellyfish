...
/**
 * 工具调用命令：ReAct 循环请求执行一次工具调用，由插件管理器按工具名路由。
 * <p>
 * 路由键即工具名，因此每个工具对应一个处理器。
 *
 * @author zcd
 */
public final class ToolCallCommand extends Command<ToolCallResult> {
     ...
     */
    public ToolCallCommand(String toolName, Map<String, Object> arguments, String sessionId, long timeoutMillis) {
